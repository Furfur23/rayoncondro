...
@section('content')
    ...
    <div class="grid grid-cols-2 gap-3 mb-6">
        ...
        <div class="bg-white rounded-xl p-4 shadow-sm border border-gray-100">
            ...
            <p class="text-3xl font-bold text-blue-600">{{ $total_warga }}</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-2 gap-3 mb-6">
        ...
        <a href="#"
            class="bg-blue-600 hover:bg-blue-700 text-white rounded-xl p-4 text-center shadow-sm transition">
            <span class="text-3xl block mb-1">👥</span>
            <span class="text-sm font-semibold">Data Anggota</span>
        </a>
        <a href="{{ route('admin.presensi.rekap') }}"
            class="bg-purple-600 hover:bg-purple-700 text-white rounded-xl p-4 text-center shadow-sm transition">
            <span class="text-3xl block mb-1">📊</span>
            <span class="text-sm font-semibold">Rekap Presensi</span>
        </a>
    </div>
@endsection